...
const Navbar = () => {
  ...
  <svg viewBox="0 0 420 100" width="200" height="48" xmlns="http://www.w3.org/2000/svg">
    ...
    <text x="98" y="46" font-family="'Trebuchet MS', Arial, sans-serif" font-size="28" font-weight="700" fill="#1e293b" letter-spacing="-0.5">AP Exam Finder</text>
    <rect x="98" y="52" width="44" height="3" rx="1.5" fill="#7c3aed"/>
    <text x="99" y="72" font-family="Arial, sans-serif" font-size="12" fill="#94a3b8" letter-spacing="2">GOVERNMENT EXAM PORTAL</text>
  </svg>
</NavLink>
